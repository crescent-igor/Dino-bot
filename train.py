    ...
    try:
        while True:
            ...
            if nb_observation > 0 and t > nb_observation:
                indxes = np.random.choice(len(memory), batch_size, replace=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--nb_actions", help="Number of possible actions for bot", default=2, type=int)
    parser.add_argument("--initial_epsilon", help="epsilon start value", default=0.1, type=float)
    parser.add_argument("--final_epsilon", help="epsilon end value", default=1e-4, type=float)
    parser.add_argument("--gamma", help="gamma value for reward attenuation", default=0.99, type=float)
    parser.add_argument("--nb_memory", help="Memory to store previous states and rewards for training.", default=50000, type=int)
    ...
    parser.add_argument("--nb_observation", help="Number of observations before starting training", default=100, type=int)
    parser.add_argument("--use_cuda", help="Use cuda if it's avaulable", dest="use_cuda", action="store_true")
    parser.add_argument("--exploiting", help="If enabled, there is no training the Q-network just predict the Q-values.", action="store_true")
    ...
    parser.add_argument("--game_speed", help="Speed of the game (better cpu/gpu helps with better speeds)", default=0, type=int)
